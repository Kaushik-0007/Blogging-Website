<%-- 
    ...
    Created on : 20 Apr 2024, 05:11:24
    Author     : family
--%>
...
<html>
    ...
    <body>
        <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v19.0" nonce="pwLJlVGp"></script>
...
<!--                            <a href="#!" class="btn btn-outline-light btn-sm"> <i class="fa fa-commenting-o"></i> <span>20</span>  </a>-->
                            ...
                            <div class=""card-footer">
                                  <div class="fb-comments" data-href="http://localhost:8081/Blog/show_blog_page.jsp?post_id=<%=p.getPid()%>" data-width="" data-numposts="5"></div>
                            </div>
